...
public class Main {
    ...
    public static void main(String[] args) {
        int[] mass1 = {2, 3, 91, 9, 92, 63, 81, 12, 83};
        int[] mass2 = {2, 3, 91, 9, 92, 63, 81, 12, 83};
        int[] mass3 = {2, 3, 91, 9, 92, 63, 81, 12, 83};

        SortIns(mass1);
        PrintMass(mass1);

        homework6.SortingStudentsByGPA obj2 = new homework6.SortingStudentsByGPA();
